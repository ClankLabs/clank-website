...
**Installer**
Download `Clank CLI_setup.exe` from [GitHub Releases](https://github.com/ItsTrag1c/Clank-Chat/releases/latest). Installs to `C:\Program Files\Clank CLI\` and adds `clank` to your system PATH.
